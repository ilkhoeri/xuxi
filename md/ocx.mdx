...
5. **Retaining Falsy Values (`x.object.raw()`):** <br />
   - If you need to **keep falsy values while merging**, use `x.object.raw()`.
...
console.log(response); // { id: 123, name: 'Alice', settings: { theme: 'light' } }
```
...
<summary className="*:select-none select-none cursor-pointer"><b>Examples Inputs :</b></summary>
...
const user = {
  ...
  lastLogin: "2025-05-30T14:32:00Z",
  ...
  activityHistory: [
    ...
    },
    {
      ...
      timestamp: "2025-05-28T10:12:00Z",
      changes: ["email", "phone"]
    },
    {
  ...
  securityAlerts: [
    {
      ...
      timestamp: "2025-05-15T22:45:00Z",
      location: "Russia",
      status: "blocked"
    },
    {
  ...
  sessions: {
    ...
    mobileApp: {
      active: true,
      lastLogin: "2025-05-28T11:12:00Z",
      device: "iPhone 15 Plus"
    }
  },
  organizations: [
...
const preferences = {
  ...
  integrations: {
    googleDrive: { enabled: true, lastSync: "2025-05-15T09:00:00Z" },
    dropbox: { enabled: false },
    slack: { enabled: true, lastSync: "2025-05-10T12:30:00Z" }
  },
  shortcuts: [
...
const metadata = {
  ...
  latestUpdated: "2025-05-01T12:45:00Z",
  isActive: false,
  isPremium: true,
  ...
  subscription: {
    ...
    invoices: [
      ...
      { id: "INV-002", date: "2025-05-15", amount: 299.99, status: "Pending" }
    ],
    usageStats: {
      storageUsed: "150GB",
      apiCalls: 12500,
      lastBillingCycle: "2025-05-01T00:00:00Z"
    }
  },
  security: {
  ...
  devices: [
    {
      ...
      lastActive: "2025-05-29T22:15:00Z",
      status: "trusted"
    },
    {
      ...
      lastActive: "2025-05-25T18:05:00Z",
  ...
  accessedApps: [
    { name: "VS Code", lastUsed: "2025-05-29T22:10:00Z" },
    { name: "GitHub", lastUsed: "2025-05-30T09:00:00Z" },
    { name: "Slack", lastUsed: "2025-05-28T15:45:00Z" }
  ]
};
...
const updated = {
  notifications: {
    ...
    weeklyReport: { enabled: true, lastSent: "2025-05-29T10:00:00Z" }
  },
  colors: {
    dark: "shane",
    light: "salmon",
...
<details className="my-4">
<summary className="*:select-none select-none cursor-pointer"><b>Result:</b></summary>
...
```json
{
  ...
  "preferences": {
    ...
    "integrations": {
      "googleDrive": {
        "enabled": true,
        "lastSync": "2025-05-15T09:00:00Z"
      },
      "slack": {
        "enabled": true,
        "lastSync": "2025-05-10T12:30:00Z"
      }
    },
    "shortcuts": [
      {
  ...
  "metadata": {
    ...
    "accessedApps": [
      {
        "name": "VS Code",
        "lastUsed": "2025-05-29T22:10:00Z"
      },
      {
        "name": "GitHub",
        "lastUsed": "2025-05-30T09:00:00Z"
      },
      {
        "name": "Slack",
        "lastUsed": "2025-05-28T15:45:00Z"
      }
    ]
  },
...
const serializedQuery = new URLSearchParams(x.ocx(queryParams)).toString();
...
- Provides `x.object.raw()` chaining If you need to **keep falsy values ​​while merger** (very useful for debugging).
